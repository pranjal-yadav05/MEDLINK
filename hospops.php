...
<html lang="en">
    <head>
        ...
        <title> MedLink | Hospital Operations </title>
    </head>
<body>
        <div class="header">
        ...
        <div class="content">
            ...
            <div id="myModal" class="modal">
                <div class="design">
                    ...
                    <form class="new" method="POST">
                        ...
                        <br><button type="submit" name="submit" class="form-btn" id="submit-btn" formaction="hospops.php">Submit</button>
                    </form>
                </div>
            </div>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    $stmt = $conn->prepare("INSERT INTO hospops (post_name, post_user, post, post_date) VALUES (?, ?, ?, ?)");
